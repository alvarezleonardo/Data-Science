...
**[APUNTES-DATA-SCIENCE.md](APUNTES-DATA-SCIENCE.md)** — manual del programa, ordenado de lo más básico a lo más complejo: **49 capítulos en 9 partes**, con 31 diagramas y una referencia técnica de consulta.
...
| 07 | [Fundamentos de Deep Learning](07-fundamentos-de-deep-learning/) | 7 | 33 | [caps. 39-49](APUNTES-DATA-SCIENCE.md#parte-ix--deep-learning-con-frameworks) | 🔄 En curso — Módulos 1 a 4 completos (CNNs y RNNs) |
...
├── APUNTES-DATA-SCIENCE.md       ← manual del programa (49 capítulos, 9 partes)
