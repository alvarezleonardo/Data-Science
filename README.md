...
**[APUNTES-DATA-SCIENCE.md](APUNTES-DATA-SCIENCE.md)** — manual del programa, ordenado de lo más básico a lo más complejo: **47 capítulos en 9 partes**, con 28 diagramas y una referencia técnica de consulta.
...
| 07 | [Fundamentos de Deep Learning](07-fundamentos-de-deep-learning/) | 7 | 33 | [caps. 39-47](APUNTES-DATA-SCIENCE.md#parte-ix--deep-learning-con-frameworks) | 🔄 En curso — CNNs completas · RNNs y GRU documentadas |
...
├── APUNTES-DATA-SCIENCE.md       ← manual del programa (47 capítulos, 9 partes)
